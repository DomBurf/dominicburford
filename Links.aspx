<%@ Page Language="C#" MasterPageFile="~/Default.master" Title="Dominic Burford | Links"
...
<asp:content id="Content1" contentplaceholderid="Main" runat="server">
    ...
    <div class="page" id="links">
        <div id="content">
            ...
            <h4>Google+</h4>
            <dl>
                <dt><a href="https://plus.google.com/+DominicBurford/" target="_blank">Google+</a> </dt>
                <dd>Read my updates</dd>
            </dl>
            
            <h4>Cycling e-zine</h4>
            <dl>
                <dt><a href="http://openzine.com/publisherzine.aspx-ID=5005.html" target="_blank">Openzine</a> </dt>
                <dd>Read my cycling adventures</dd>
            </dl>
